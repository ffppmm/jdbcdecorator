...
/**
 * 
 * Entrypoint for the our logging system.
 * 
 * @author Franz Philipp Moser
 *
 */
public class ConnectionLogger extends ConnectionDecorator {
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		return new PreparedStatementLogger(connection.prepareStatement(sql), sql);
	}
